<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AirCompressorH.aspx.cs" Inherits="factory.AirComp.AirCompressorH" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="border:1px solid rgba(0, 0, 0, 0.125);background:aliceblue;">
        ...
        <div class="row">
            ...
            <div class="col-auto" style="align-self:center;">
                <strong>
                    <asp:Label ID="Label2" runat="server" Text="空壓機/日管理" CssClass="auto-style1"></asp:Label>
                </strong>
            </div>
            <div class="col" style="align-self:center;">
                <div class="text-right">
                    <strong>
                        <asp:HyperLink ID="hyl_mgt" runat="server" CssClass="auto-style1">空壓機/月管理</asp:HyperLink>
                    </strong>
                </div>
            </div>
        </div>
    ...
    <div class="GV1 table-responsive">
        <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" CssClass="table table-sm table-hover table-bordered text-center" DataSourceID="SDS1" DataKeyNames="FactoryID,DataDate">
            <Columns>
                ...
                <asp:TemplateField HeaderText="日期" SortExpression="DataDate">
                    ...
                    <ItemTemplate>
                        <asp:HyperLink ID="hyl_datatime" runat="server" Text='<%# Bind("DTime", "{0:MM/dd HH:mm}") %>'></asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="用電量">
                    ...
                    <HeaderTemplate>
                        <asp:CheckBox ID="ch_p0" runat="server" AutoPostBack="True" OnCheckedChanged="ch_p0_CheckedChanged" /><br>用電量
                    </HeaderTemplate>
                    <ItemTemplate>
                        <asp:Label ID="lb_p0" runat="server" Text='<%# Bind("Power_C", "{0:N2}") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="#1運轉(分)" SortExpression="WorkTime_01">
                    <EditItemTemplate>
                    ...
                    <HeaderTemplate>
                        ...
                        <asp:Label ID="lb_r1" runat="server" Text="#1&lt;br&gt;運轉(分)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#2運轉(分)" SortExpression="WorkTime_02">
                    <EditItemTemplate>
                    ...
                    <HeaderTemplate>
                        ...
                        <asp:Label ID="lb_r2" runat="server" Text="#2&lt;br&gt;運轉(分)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#3運轉(分)" SortExpression="WorkTime_03">
                    <EditItemTemplate>
                    ...
                    <HeaderTemplate>
                        ...
                        <asp:Label ID="lb_r3" runat="server" Text="#3&lt;br&gt;(運轉分)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#4運轉(分)" SortExpression="WorkTime_04">
                    <EditItemTemplate>
                    ...
                    <HeaderTemplate>
                        ...
                        <asp:Label ID="lb_r4" runat="server" Text="#4&lt;br&gt;運轉(分)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#5&lt;br&gt;KWH(時)" SortExpression="Power_CH_05">
                    ...
                    <HeaderTemplate>
                        <asp:Label ID="lb_r10" runat="server" Text="#5&lt;br&gt;KWH(時)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#5運轉(分)" SortExpression="WorkTime_05">
                    <EditItemTemplate>
                    ...
                    <HeaderTemplate>
                        ...
                        <asp:Label ID="lb_r5" runat="server" Text="#5&lt;br&gt;運轉分"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
        ...
        <asp:SqlDataSource ID="SDS1" runat="server" ConnectionString="<%$ ConnectionStrings:ZDBConnStr %>" SelectCommand="SELECT * FROM [G_Air_Comp_H] WHERE (([FactoryID] = @FactoryID) AND ([MID] = @MID))">
            <SelectParameters>
