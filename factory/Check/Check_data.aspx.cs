    ...
    public partial class Check_data : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    Response.Redirect("Check_data.aspx?F=KY&M=0&D="+md+"");
                }
                ...
                {
                    Response.Redirect("Check_data.aspx?F=" + F + "&M=0&D=" + md + "");
                }
                ...
                {
                    Response.Redirect("Check_data.aspx?F=" + F + "&M="+M+"&D=" + md + "");
                }
                ...
                tb_SDATE.Text = DateTime.Now.ToString("yyyy-"+D.Replace("/","-")+"");
                ...
                hyl_M0.NavigateUrl = "Check_data.aspx?F=" + F + "&M=0&D=" + D + "";
                if (dt.Rows.Count > 0)
                {
                    if (dt.Rows.Count == 4)
                    {
                        ...
                        hyl_M2.Text = t2;
                        hyl_M2.NavigateUrl = "Check_data.aspx?F=" + F + "&M=3&D=" + D + "";

                        string t3 = dt.Rows[2][0].ToString();
                        hyl_M3.Text = t3;
                        hyl_M3.NavigateUrl = "Check_data.aspx?F=" + F + "&M=5&D=" + D + "";

                        string t4 = dt.Rows[3][0].ToString();
                        hyl_M4.Text = t4;
                        hyl_M4.NavigateUrl = "Check_data.aspx?F=" + F + "&M=7&D=" + D + "";
                    }
                    ...
                    hyl_M1.Text = t1;
                    hyl_M1.NavigateUrl = "Check_data.aspx?F=" + F + "&M=1&D=" + D + "";
                }
                else
                {
                ...
                if (M == "0")
                {
                    ...
                    */
                    SDS1.SelectCommand = "SELECT Q.DateTime, Q.Mill_ID, P.ProductName, Q.Moisture, Q.Specific_Surface, Q.Residual_On_Sieve From A_Product_Quality as Q " +
                        "LEFT JOIN A_Product AS P ON Q.ProductID = P.ProductID " +
                        "WHERE DTime >= @D1 AND DTime < @D2 AND FactoryID LIKE @F+'%' AND Visible IS NULL";
                ...
                else
                {
                    ...
                    */
                    SDS1.SelectCommand = "SELECT Q.DateTime, Q.Mill_ID, P.ProductName, Q.Moisture, Q.Specific_Surface, Q.Residual_On_Sieve From A_Product_Quality as Q " +
                        "LEFT JOIN A_Product AS P ON Q.ProductID = P.ProductID " +
                        "WHERE DTime >= @D1 AND DTime < @D2 AND FactoryID LIKE @F+'%' AND Mill_ID = @M AND Visible IS NULL";
        ...
        protected void DDL_factory_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("Check_data.aspx?F="+DDL_factory.Text+"&M=0&D=" + D + "");
        }
        ...
        protected void tb_SDATE_TextChanged(object sender, EventArgs e)
        {
            ...
            string D = tb_SDATE.Text.Substring(5, 5).Replace("-", "/");
            string M = Request.QueryString["M"];
            Response.Redirect("Check_data.aspx?F=" + DDL_factory.Text + "&M="+M+"&D=" + D + "");
        }
