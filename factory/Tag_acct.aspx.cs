        ...
        protected void btn_confirm_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < GV2.Rows.Count; i++)
            {
                ...
                */
                ...
                string sql = "IF NOT EXISTS (SELECT * FROM TagList WHERE TagName = '"+TagName+ "') BEGIN INSERT INTO TagList VALUES ('"+ServerName+"', '"+TagName+"','"+SourceTag+"','"+TagDesc+"','"+ bl_Rep_Live + "','"+ bl_Rep_Hour + "','"+ bl_Rep_Min + "') END";
                db.RunCmd(sql);
            }
            Response.Redirect("Tag_update.aspx");
        }
