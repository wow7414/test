<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="PV_D.aspx.cs" Inherits="factory.PV.PV_D" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-auto" style="align-self:center;">
                <strong>
                    <asp:Label ID="Label2" runat="server" Text="太陽能/月管理" CssClass="auto-style1"></asp:Label>
                </strong>
            </div>
        </div>
        </div>
        ...
        <div class="row justify-content-center" style="margin:0px">
            <div class="col-12 col-xl-7" style="padding:0px">
                <div class="GV1 table-responsive">
                    <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" CssClass="table table-sm table-hover table-bordered text-center" DataSourceID="SDS1" OnDataBound="GV1_DataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="時間" SortExpression="DDate">
                                <EditItemTemplate>
                                    <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("DDate") %>'></asp:TextBox>
                                </EditItemTemplate>
                                <ItemTemplate>
                                    <asp:HyperLink ID="hyl_datatime" runat="server" Text='<%# Bind("DDate", "{0:MM/dd}") %>'></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="Power_Generation" HeaderText="每日發電量(度)" SortExpression="Power_Generation" />
                            <asp:BoundField DataField="Lost_Power" HeaderText="遺失功率" SortExpression="Lost_Power" />
                    ...
                    <asp:SqlDataSource ID="SDS1" runat="server" ConnectionString="<%$ ConnectionStrings:ZDBConnStr %>" SelectCommand="SELECT [DDate], [Power_Generation], [Lost_Power], [kwh_avg] FROM [G_SE_D]"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
