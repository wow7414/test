<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Power_H.aspx.cs" Inherits="factory.power.Power_H" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="border:1px solid rgba(0, 0, 0, 0.125);background:aliceblue;">
        ...
        <div class="row">
            ...
            <div class="col-auto" style="align-self:center;">
                <strong>
                    <asp:Label ID="Label2" runat="server" Text="用電量/日管理" CssClass="auto-style1"></asp:Label>
                </strong>
            </div>
            <div class="col" style="align-self:center;">
                <div class="text-right">
                    <strong>
                        <asp:HyperLink ID="hyl_mgt" runat="server" CssClass="auto-style1">用電量/月管理</asp:HyperLink>
                    </strong>
                </div>
            </div>
        </div>
    ...
    <div class="GV1 table-responsive">
        <asp:GridView ID="GV1" runat="server" AutoGenerateColumns="False" CssClass="table table-sm table-hover table-bordered text-center" DataSourceID="SDS1">
            <Columns>
                <asp:BoundField DataField="DTime" DataFormatString="{0:MM/dd HH:mm}" HeaderText="日期" SortExpression="DTime" />
                ...
                <asp:TemplateField HeaderText="#7&lt;br&gt;KWH(時)" SortExpression="Power_C_07">
                    ...
                    <HeaderTemplate>
                        <asp:CheckBox ID="ch_p7" runat="server" AutoPostBack="True" OnCheckedChanged="ch_p0_CheckedChanged" /><asp:Label ID="lb_n7" runat="server" Text="#7&lt;br&gt;KWH(時)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="#8&lt;br&gt;KWH(時)" SortExpression="Power_C_08">
                    ...
                    <HeaderTemplate>
                        <asp:CheckBox ID="ch_p8" runat="server" AutoPostBack="True" OnCheckedChanged="ch_p0_CheckedChanged" /><asp:Label ID="lb_n8" runat="server" Text="#1&lt;br&gt;KWH(時)"></asp:Label>
                    </HeaderTemplate>
                    <ItemTemplate>
        ...
        <asp:SqlDataSource ID="SDS1" runat="server" ConnectionString="<%$ ConnectionStrings:ZDBConnStr %>" SelectCommand="SELECT [Power_C_Total], [Power_C_01], [Power_C_02], [Power_C_03], [Power_C_04], [Power_C_05], [Power_C_06], [Power_C_07], [Power_C_08], [DTime] FROM [G_Power_h]"></asp:SqlDataSource>
    </div>
