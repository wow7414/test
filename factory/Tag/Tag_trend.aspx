...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <asp:TextBox ID="tb_SDATE" runat="server"  TextMode="SingleLine" placeholder="選擇日期" Width="130px" required autocomplete="off" onkeydown="return false;"></asp:TextBox>
        <asp:Label ID="Label3" runat="server" Text="結束時間:"></asp:Label>
        <asp:TextBox ID="tb_EDATE" runat="server"  TextMode="SingleLine" placeholder="選擇日期" Width="130px" required autocomplete="off" onkeydown="return false;"></asp:TextBox>
