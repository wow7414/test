...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row justify-content-center text-center" style="margin:10px 0px 20px 0px;height:80px">
            <div class="c col-5" style="margin-right:10px;padding-top:25px" onclick="location.href='/Check/Check_data.aspx?F=LZ&M=0';"> 
                <strong> 
                    <asp:Label ID="Label5" runat="server" Text="檢測數據"></asp:Label>
                </strong>
            </div>

            <div class="c col-5" style="margin-left:10px;padding-top:25px" onclick="location.href='/Check/add_data.aspx?F=LZ';"> 
                <strong> 
        ...
        <div class="row justify-content-center text-center" style="margin:10px 0px 20px 0px;height:80px">
            <div class="c col-5" style="margin-right:10px;padding-top:25px" onclick="location.href='/PV/PV_H.aspx?F=LZ-T1HIST';"> 
                <strong> 
